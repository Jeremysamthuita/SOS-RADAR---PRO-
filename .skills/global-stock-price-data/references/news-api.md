...
**Endpoint:** `GET https://app-enx39clvtkht-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-enx39clvtkht-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
