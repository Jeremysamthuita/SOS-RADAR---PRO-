...
| Item | Details |
|------|---------|
| Endpoint | `GET https://app-enx39clvtkht-api-M9v0wzOkZXGY.gateway.appmedo.com/v1/images/generations/{task_id}` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-enx39clvtkht-api-M9v0wzOkZXGY.gateway.appmedo.com/v1/images/generations/${taskId}`,
    {
      method: "GET",
      headers: {
