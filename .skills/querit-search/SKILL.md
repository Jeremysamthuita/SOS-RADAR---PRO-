...
- **Upstream**: `https://app-enx39clvtkht-api-w9Rb5Jdedqq9.gateway.appmedo.com/v1/search`
- **Gateway marker URL (rewritten per app)**: `POST https://app-enx39clvtkht-api-w9Rb5Jdedqq9.gateway.appmedo.com/v1/search`
