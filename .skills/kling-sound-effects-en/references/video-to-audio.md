...
- **Method**: `POST`
- **Endpoint**: `https://app-enx39clvtkht-api-NLZ1R6MBQ4J9.gateway.appmedo.com/v1/audio/video-to-audio`
- **Headers**:
...
```bash
curl --request POST \
  --url https://app-enx39clvtkht-api-NLZ1R6MBQ4J9.gateway.appmedo.com/v1/audio/video-to-audio \
...
- **Method**: `GET`
- **Endpoint**: `https://app-enx39clvtkht-api-NLZ1R6MBQ4J9.gateway.appmedo.com/v1/audio/video-to-audio/{task_id}`
### Path Parameters
...
```bash
curl --request GET \
  --url https://app-enx39clvtkht-api-NLZ1R6MBQ4J9.gateway.appmedo.com/v1/audio/video-to-audio/{task_id}
```
