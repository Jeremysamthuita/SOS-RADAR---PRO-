...
- **Method**: `POST`
- **Endpoint**: `https://app-enx39clvtkht-api-ELbW03DAPQrY.gateway.appmedo.com/v1/audio/text-to-audio`
- **Headers**:
...
```bash
curl --request POST \
  --url https://app-enx39clvtkht-api-ELbW03DAPQrY.gateway.appmedo.com/v1/audio/text-to-audio \
...
- **Method**: `GET`
- **Endpoint**: `https://app-enx39clvtkht-api-ELbW03DAPQrY.gateway.appmedo.com/v1/audio/text-to-audio/{task_id}`
- **Headers**:
  - `Content-Type`: `application/json` (Required)
...
```bash
curl --request GET \
  --url https://app-enx39clvtkht-api-ELbW03DAPQrY.gateway.appmedo.com/v1/audio/text-to-audio/{task_id} \
  --header 'Content-Type: application/json'
```
