...
**Endpoint:** `GET https://app-enx39clvtkht-api-n9QVxo8blgrL.gateway.appmedo.com/v1/images/omni-image/{task_id}`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-enx39clvtkht-api-n9QVxo8blgrL.gateway.appmedo.com/v1/images/omni-image/${taskId}`,
    {
      method: "GET",
      headers: {
