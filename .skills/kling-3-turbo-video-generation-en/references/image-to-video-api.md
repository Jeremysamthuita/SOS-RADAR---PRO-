...
|---|---|
| Region | Singapore |
| Third-party domain | `app-enx39clvtkht-api-e94GlB86xpEa.gateway.appmedo.com` |
| Method | `POST` |
...
| API Plugin endpoint | `POST https://app-enx39clvtkht-api-e94GlB86xpEa.gateway.appmedo.com/image-to-video/kling-3.0-turbo` |
...
while (true) {
  const queryResponse = await fetch(
    `https://app-enx39clvtkht-api-GaDwzVOqmRNY.gateway.appmedo.com/tasks?task_ids=${encodeURIComponent(taskId)}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
