...
| Item | Details |
|------|---------|
| Endpoint | `GET https://app-enx39clvtkht-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/{task_id}` |
...
| Item | Details |
|------|---------|
| Endpoint | `GET https://app-enx39clvtkht-api-pLVzAAkGZwDL.gateway.appmedo.com/v1/images/editing/expand` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-enx39clvtkht-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/${task_id}`,
    {
      method: "GET",
      headers: {
