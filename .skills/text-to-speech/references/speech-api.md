...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-enx39clvtkht-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech` |
| HTTP Method | `POST` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- Call upstream ---
  const upstream = await fetch("https://app-enx39clvtkht-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech", {
    method: "POST",
    headers: {
